...
remote_data_basepath = (
    "https://raw.githubusercontent.com/CollectorDevTeam/assets/master/data/"
)
            ...
            for key in files.keys():
                ...
                if raw_data is None:
                    ...
                    field = data.add_field(
                        name=key,
                        value="0/{} completed".format(len(raw_data["strings"])),
                    )
                    counter = 0
                    for dlist in raw_data["strings"]:
                        ...
                        data.set_field_at(
                            af,
                            name=key,
                            value="{}/{} completed".format(
                                counter, len(raw_data["strings"])
                            ),
                        )
                    package += "\n{} stored".format(key)
